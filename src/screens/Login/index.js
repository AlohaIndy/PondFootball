                    ...
                    <Content
                        ...
                        <View
                            ...
                            <Form
                                ...
                                <Item rounded style={styles.inputLoginUsername}>
                                    <Input style={styles.inputText} placeholder='Username'/>
                                </Item>
                                <Item rounded style={styles.inputLoginPassword}>
                                    <Input secureTextEntry={true} style={styles.inputText} placeholder='Password'/>
                                </Item>
                                <Button block light style={styles.btnLogin}>
